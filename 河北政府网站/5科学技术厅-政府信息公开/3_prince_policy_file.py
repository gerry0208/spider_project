...
file = open('省政府政策文件.csv', 'a', encoding='utf-8', newline='')
writer = csv.writer(file)
writer.writerow(['标题', '时间', '内容', '一级类别', '来源网站', '访问地址', '附件链接'])

for page in range(1, 7):

    url = f"https://kjt.hebei.gov.cn/www/xxgk2020/228104/228107/1842c67f-{page}.html"

    headers = {
      'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36",
      'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
      'referer': f"https://kjt.hebei.gov.cn/www/xxgk2020/228104/228107/1842c67f-{page}.html"
    }
    ...
    for li in li_list:
        ...
        try:
            ...
            writer.writerow([title, time_stamp, text, '省政府政策文件', url, detial_url, appendix_url_text])
        except:
            pass
