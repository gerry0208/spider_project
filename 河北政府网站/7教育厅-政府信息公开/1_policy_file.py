...
def get_data(name, id, page_num):
    ...
    writer.writerow(['标题', '时间', '效力状态', '内容', '一级类别', '来源网站', '访问地址', '附件链接'])
    ...
    for page in range(1, page_num + 1):
        ...
        for tr in tr_list:
            ...
            print(title, time_stamp, potency, detial_url)
            writer.writerow([title, time_stamp, potency, text, name, url, detial_url, appendix_url_text])
